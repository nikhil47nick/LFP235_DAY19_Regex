...
//        emailCheck(scr.next());
        ...
        emailCheck("abc@yahoo.com");
        emailCheck("abc-100@yahoo.com");
        emailCheck("abc.100@yahoo.com");
        emailCheck("abc111@abc.com");
        emailCheck("abc-100@abc.net");
        emailCheck("abc.100@abc.com.au");
        emailCheck("abc@1.com");
        emailCheck("abc@gmail.com.com");
        emailCheck("abc+100@gmail.com");
    }
}
